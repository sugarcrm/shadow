...
/*
 *  pulled from:
 *  https://github.com/php/php-src/blob/7728160784785771d1933f5f0a8c4d7a735470b0/main/streams/plain_wrapper.c#L63-L119
 *  due to missing header (should be fixed in 7.3)
 */
#if PHP_VERSION_ID < 70300
int php_stream_parse_fopen_modes(const char *mode, int *open_flags)
{
	int flags;
